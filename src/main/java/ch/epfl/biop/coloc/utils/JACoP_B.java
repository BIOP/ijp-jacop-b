...
public class JACoP_B implements PlugIn, ActionListener, ChangeListener, ItemListener, ImageListener, PropertyChangeListener, WindowListener  {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (origin==imgA){
            ...
            if (prevImgA!=(int)imgB.getSelectedItem()){
        ...
        if (origin==imgB){
            ...
            if (prevImgB!=(int)imgA.getSelectedItem()){
